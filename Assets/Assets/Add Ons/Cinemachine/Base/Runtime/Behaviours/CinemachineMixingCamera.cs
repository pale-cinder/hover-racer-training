...
{
    /// <summary>
    /// Cinemachine FixedBlend is a "manager camera" that takes on the state of 
    /// the weighted average of the states of the referenced virtual cameras.
    /// </summary>
    ...
    {
        /// <summary>The maximum number of tracked cameras.  If you want to add more cameras,
        /// do it here, and be sure to add the extra member variables and to make
        /// the appropriate changes in GetWeight() and SetWeight().
        /// The inspector will figure itself out based on this value.</summary>
        public const int MaxCameras = 8;

        /// <summary>The tracked cameras.  We do it this way instead of with a variable
        /// length array in order to support weight animation from the Timeline.
        /// Timeline cannot animate array elements.</summary>
